    ...
    public partial class InitialUser : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "permissions", "polls:read", "7e6afdc1-9582-4330-a0cd-8b41490a39b7" },
                    { 2, "permissions", "polls:add", "7e6afdc1-9582-4330-a0cd-8b41490a39b7" },
                    { 3, "permissions", "polls:update", "7e6afdc1-9582-4330-a0cd-8b41490a39b7" },
                    { 4, "permissions", "polls:delete", "7e6afdc1-9582-4330-a0cd-8b41490a39b7" },
                    { 5, "permissions", "questions:read", "7e6afdc1-9582-4330-a0cd-8b41490a39b7" },
                    { 6, "permissions", "questions:add", "7e6afdc1-9582-4330-a0cd-8b41490a39b7" },
                    { 7, "permissions", "questions:update", "7e6afdc1-9582-4330-a0cd-8b41490a39b7" },
                    { 8, "permissions", "users:read", "7e6afdc1-9582-4330-a0cd-8b41490a39b7" },
                    { 9, "permissions", "users:add", "7e6afdc1-9582-4330-a0cd-8b41490a39b7" },
                    { 10, "permissions", "users:update", "7e6afdc1-9582-4330-a0cd-8b41490a39b7" },
                    { 11, "permissions", "roles:read", "7e6afdc1-9582-4330-a0cd-8b41490a39b7" },
                    { 12, "permissions", "roles:add", "7e6afdc1-9582-4330-a0cd-8b41490a39b7" },
                    { 13, "permissions", "roles:update", "7e6afdc1-9582-4330-a0cd-8b41490a39b7" },
                    { 14, "permissions", "results:read", "7e6afdc1-9582-4330-a0cd-8b41490a39b7" }
                });
