...
public static class RoleErrors
{
    ...
    public static readonly Error DuplicateRole =
          new("Role.DuplicateRole", "Role already exists", StatusCodes.Status409Conflict);

    public static readonly Error InvalidPermissions =
        new("Role.InvalidPermissions", "InvalidPermissions", StatusCodes.Status400BadRequest);
